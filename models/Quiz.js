...
const QuizSchema = new mongoose.Schema( { assessmentCode: { type:
String, default: undefined, trim: true, uppercase: true, index: true, },
...
QuizSchema.index({ audience: 1, isPublished: 1, accessLevel: 1,
createdAt: -1, });
